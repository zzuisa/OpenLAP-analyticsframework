...
/**
 * A custom Java Class Path Loader that is responsible for loading JARs dynamically to the active ClassPath.
 * It uses the JCL';
 */
public class AnalyticsMethodsClassPathLoader {
	 ...
	 * @return An AnalyticsMethods that is loaded from the JAR.
